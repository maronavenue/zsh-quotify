...
The real dummies are the people who–though technically expert–couldn’t design hardware\n\
and software that’s usable by normal consumers if their lives depended upon it.”\n(Walter Mossberg)"
...
"“A programmer is a person who passes as an exacting expert on the basis of being able to turn out,\n\
after innumerable punching, an infinite series of incomprehensive answers calculated with micrometric\n\
precisions from vague assumptions based on debatable figures taken from inconclusive documents and\n\
carried out on instruments of problematical accuracy by persons of dubious reliability and questionable\n\
mentality for the avowed purpose of annoying and confounding a hopelessly defenseless department\n\
...
development group (say, 7-8 people) would have a hard time getting together over a year.\n\
...
They are an order-of-magnitude better, measured by whatever standard: conceptual creativity, speed,\n\
...
"“One of the main causes of the fall of the Roman Empire was that–lacking zero–they had no way\n\
...
right as we had thought. Debugging had to be discovered. I can remember the exact instant\n\
when I realized that a large part of my life from then on was going to be spent in finding\n\
